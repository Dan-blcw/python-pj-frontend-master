...
<template>
  <div class="w-full mb-20">
    <div
      class="flex items-center justify-center relative bg-[url('https://theme.hstatic.net/1000026602/1001232314/14/img-banner-index.jpg?v=107')] bg-no-repeat bg-cover bg-center bg-fixed mt-5 w-full h-[280px] rounded-t-xl"
    >
